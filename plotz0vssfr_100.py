...
for i in wlmda:
    try:
        x=ascii.read('flowinfo/flowinfo_100_4_'+str(int(obj['haloid'][i]))+'.txt')
...
for i in wlmd:
    try:
        x=ascii.read('flowinfo/flowinfo_100_2_'+str(int(obj['haloid'][i]))+'.txt')
    except FileNotFoundError:
        continue
...
for i in wxmda:
    x=ascii.read('flowinfo/flowinfo_100_3_'+str(int(obj['haloid'][i]))+'.txt')
...
for i in wxmd:
    x=ascii.read('flowinfo/flowinfo_100_1_'+str(int(obj['haloid'][i]))+'.txt')
...
plt.ylabel(r'$Z_{\rm gas}$')
plt.colorbar(label=r'$\log$ SFR/$M_{\rm dense~gas}$ (Gyr$^{-1}$)')
plt.savefig('z0zgasmod2_100.png')
...
plt.ylabel(r'$Z_{\rm gas}$')
plt.colorbar(label=r'$\log$ SFR/$M_{\rm dense~gas}$ (Gyr$^{-1}$)')
plt.savefig('z0zgasmod3_100.png')
...
plt.savefig('etavsresidual_100.png')

plt.clf()
plt.scatter(allsfe,allzf,c=np.log10(allz0))
plt.loglog()
plt.savefig('sfezz0_100.png')

plt.clf()
plt.scatter(allz0,allzf,c=np.log10(allsfe))
plt.loglog()
plt.savefig('z0sfezf_100.png')

plt.clf()
plt.scatter(allz0,10**minfunc2(ft2['x']),c=np.log10(allsfe))
plt.loglog()
plt.savefig('z0sfezfm_100.png')
...
plt.xlabel(r'SFR$_{z=0.13}$ (M$_\odot$~yr$^{-1}$)')
plt.ylabel(r'$Z_{\rm infall}/Z_\odot$')
plt.savefig('z0sfr_100.png')

plt.clf()
plt.scatter(allsfr2a,allznowa,c=np.log10(allmg0a))
plt.loglog()
plt.xlim(1E-4,1E-1)
plt.savefig('znowsfr_100.png')

plt.clf()
plt.plot(allsfr2a,allmz0a,'o')
plt.loglog()
plt.savefig('mz0sfr_100.png')
