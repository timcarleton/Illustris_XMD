...
obj=np.loadtxt('sampleselection_tng50_sfr5_notide_nomass.txt',skiprows=1,delimiter=',')
...
#for i in range(5):
    ...
    hf=h5py.File('/Volumes/Elements/illustris/cutouts50/'+str(int(obj[i,1]))+'/'+str(int(obj[i,1]))+'_99.hdf5')
...
tab.write('mstagesizeinfo_ca_50.txt',format='csv',overwrite=True)
