...
for typei in [1,2,3,4]:
    ...
    for i in wcat:
        ...
        h0=h5py.File('/Volumes/Elements 1/illustris/cutouts/'+str(int(obj[i,1]))+'/'+str(int(obj[i,1]))+'_'+str(99)+'.hdf5','r')
...
plt.savefig('metgrad_noscale.png')
